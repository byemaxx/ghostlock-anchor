...
OFFSETS_ENTRY("6.6.89-android15-8-g7e1f3c083cc6-abogki467167594-4k",  /* PJZ110 COS_16.0.8.301 boot.img */
  .kernel_phys_load=0xa8000000, STRUCT_OFFSETS_6_6, .off_init_task=0x0210E780, .off_init_cred=0x02120A48, .off_init_uts_ns=0x02292ED0,
  .off_empty_zero_page=0x022FE000, .off_root_task_group=0x02306580,
  .off_selinux_enforcing=0x023490E0, .off_kptr_restrict=0x0210C220,
  .off_selinux_blob_sizes=0x01665A08, .off_security_hook_heads=0x016652D0,
  .off_kmalloc_caches=0x01664E10, .off_anon_pipe_buf_ops=0x0115C0C8,
  .off_ashmem_misc_fops=0x0226C128, .off_ashmem_fops=0x012DC4D8,
  .off_ashmem_ioctl=0x00C8DE34, .off_ashmem_compat_ioctl=0x00C8E4F0,
  .off_ashmem_mmap=0x00C8E544, .off_ashmem_open=0x00C8E764,
  .off_ashmem_release=0x00C8E7EC, .off_ashmem_show_fdinfo=0x00C8E878,
  .off_configfs_read_iter=0x0049A758, .off_configfs_bin_write_iter=0x0049A960,
  .off_copy_splice_read=0x0041EC54, .off_noop_llseek=0x003D19F4,
  .off_cap_capable_active=0,
  .off_slide_nfulnl_logger=0x02102748, .off_slide_loggers_0_1=0x021026A0,
  .off_slide_boot_id=0x0236A0D8,
),
OFFSETS_ENTRY("6.6.89-android15-8-gebbf6177d5ae-ab13585131-4k",  /* oos 15.0.0.864 boot.img */
  .kernel_phys_load=0xa8000000, STRUCT_OFFSETS_6_6, .off_init_task=0x020DE280, .off_init_cred=0x020F0548, .off_init_uts_ns=0x02261F10,
  ...
  .off_selinux_blob_sizes=0x01650148, .off_security_hook_heads=0x0164FA10,
  .off_kmalloc_caches=0x0164F550, .off_anon_pipe_buf_ops=0x0114AEC8,
  .off_ashmem_misc_fops=0x0223B328, .off_ashmem_fops=0x012CB030,
  .off_ashmem_ioctl=0x00C7C614, .off_ashmem_compat_ioctl=0x00C7CCD0,
  .off_ashmem_mmap=0x00C7CD24, .off_ashmem_open=0x00C7CF44,
  .off_ashmem_release=0x00C7CFCC, .off_ashmem_show_fdinfo=0x00C7D058,
  .off_configfs_read_iter=0x0048A94C, .off_configfs_bin_write_iter=0x0048AB54,
  .off_copy_splice_read=0x0040EF70, .off_noop_llseek=0x003C1D10,
  .off_cap_capable_active=0,
  .off_slide_nfulnl_logger=0x020D2258, .off_slide_loggers_0_1=0x020D21B0,
  .off_slide_boot_id=0x02337E98,
  .off_system_unbound_wq=0x020CAE60, .off_call_usermodehelper_exec_work=0x000CFA4C,
),
